...
//
// Diamond Square Apartment Management System
//
// Features:
 ...
 * Register Resident
 * -------------------------------------------------------------
 * Owners and tenants register themselves.
 * Registration remains pending until approved
 * by one of the six admins.
 * =============================================================
 */
 ...
 * -------------------------------------------------------------
 * Allows approved users to log in.
 * Residents can later switch to Admin mode
 * if they are one of the six admins.
 * =============================================================
 */
exports.login = async (req, res) => {
    ...
    try {
        ...
        const userData = {
            ...
            // Resident can switch to Admin dashboard
            // if they are one of the approved admins.
            canSwitchToAdmin:
                user.role === "admin"
        };
 ...
 * Update Profile
 * -------------------------------------------------------------
 * Residents can edit their own profile.
 * Admin approval status remains unchanged.
 * =============================================================
 */
 ...
 * Change Password
 * -------------------------------------------------------------
 * User must provide current password before
...
// - Switch Resident/Admin Mode
// - Logout
// - Forgot Password (future-ready)
// - Complete comments and end of file

/**
 * =============================================================
 * Upload Profile Image
 * -------------------------------------------------------------
 * Updates the resident's profile image.
 * Assumes upload middleware stores the file path in req.file.
 * =============================================================
 */
 ...
 * -------------------------------------------------------------
 * One of the six admins can switch between:
 * - Resident Dashboard
 * - Admin Dashboard
 * =============================================================
 */
exports.switchDashboard = async (req, res) => {
    ...
    try {
        ...
        // Only admins can switch to admin mode
 ...
 * -------------------------------------------------------------
 * Future implementation after OTP/email verification.
 * =============================================================
 */
...
/**
 * =============================================================
 * Future Diamond Square Authentication Roadmap
 * -------------------------------------------------------------

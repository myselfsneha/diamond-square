      ...
      >
        ...
        {mobileOpen && (
          <motion.div
            ...
            className="border-t border-white/10 bg-emerald-700/95 dark:bg-slate-900"
          >
            <div className="space-y-2 px-4 py-5">
              <div className="mb-4 flex items-center justify-between rounded-2xl bg-white/10 p-3">
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white text-lg font-bold uppercase text-emerald-700">
                    {(user.name || "U").charAt(0)}
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm capitalize text-emerald-100">
                      {role}
                    </p>
                  </div>
                </div>

                <button className="relative rounded-xl bg-white/10 p-2 text-white">
                  <Bell size={20} />
              ...
              <div className="mt-5 flex items-center justify-between border-t border-white/10 pt-5">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  onClick={handleLogout}
                  className="flex items-center gap-2 rounded-xl bg-red-500 px-4 py-2 font-medium text-white hover:bg-red-600"
                >
                  <LogOut size={18} />
                  Logout
                </motion.button>

...
function AdminComplaints() {
  ...
  const complaintsContent = loading ? (
      ...
      <div className="grid md:grid-cols-3 gap-5 mt-8">
        ...
        <div className="md:col-span-2 bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 rounded-2xl shadow-lg text-white p-6">
          ...
          <p className="text-blue-100 leading-7">
            Review new complaints, update their progress, resolve resident issues
            quickly, and keep the complaint queue organized using the action
            buttons.
          </p>
        </div>
      </div>

          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>

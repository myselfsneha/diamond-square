            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {adminCards.map((card, index) => (
                ...
                >
                  <Link
                    to={card.link}
                    className="group flex h-full items-center gap-4 rounded-3xl border border-white/20 bg-white/80 p-6 shadow-xl backdrop-blur-xl transition duration-300 hover:-translate-y-2 hover:bg-gradient-to-r hover:from-blue-600 hover:to-indigo-600 hover:text-white dark:border-gray-700 dark:bg-gray-800/80 dark:hover:from-blue-700 dark:hover:to-indigo-700"
                  >
                    <div className="rounded-2xl bg-blue-100 p-3 text-blue-600 transition group-hover:bg-white/20 group-hover:text-white dark:bg-gray-700">
                      {card.icon}
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500 transition group-hover:text-blue-100 dark:text-gray-400">
                        Open module
                      </p>
                    </div>
                  </Link>

...
function Dashboard() {
  ...
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow">
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      {loading ? "..." : dashboard?.totalMembers || 0}
    </h3>
  </div>
  ...
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow">
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      {loading ? "..." : dashboard?.pendingApprovals || 0}
    </h3>
  </div>
  ...
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow">
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      {loading ? "..." : dashboard?.totalComplaints || 0}
    </h3>
  </div>
  ...
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow">
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      {loading ? "..." : dashboard?.resolvedComplaints || 0}
    </h3>
  </div>
</div>

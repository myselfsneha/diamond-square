              ...
              {adminCards.map((card) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                      {card.icon}
                    </div>

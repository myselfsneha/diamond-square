      ...
      <div className="max-w-3xl mx-auto p-6">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="phone" className="block mb-2 font-medium dark:text-white">
                Phone
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="flat_number" className="block mb-2 font-medium dark:text-white">
                Flat Number
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="date_of_birth" className="block mb-2 font-medium dark:text-white">
                Date of Birth
              </label>
              <input
                type="date"
            ...
            <div>
              <label htmlFor="anniversary_date" className="block mb-2 font-medium dark:text-white">
                Anniversary
              </label>
              <input
                type="date"

          ...
          <div className="overflow-hidden rounded-3xl border border-white/20 bg-white/80 p-8 shadow-2xl backdrop-blur-2xl dark:border-gray-700 dark:bg-gray-900/80">
            ...
            >
              ...
              <div>
                ...
                <div className="mb-3 flex items-center justify-between rounded-2xl bg-gray-100 px-4 py-3 font-mono text-lg tracking-[0.35em] dark:bg-gray-800">
                  <span>{captcha}</span>

                  <button
                    type="button"
                    onClick={generateCaptcha}
                    className="flex items-center gap-1 text-blue-600 transition hover:scale-105"
                  >
                    <RefreshCcw size={16} />
                    Refresh
                  </button>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-gray-300 bg-white px-4 py-3 focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                />
              </div>
              ...
              {/* Failed Attempts */}
              {failedAttempts >= 3 && (
                <div className="rounded-2xl border border-red-300 bg-red-50 p-3 text-sm text-red-600 dark:border-red-700 dark:bg-red-900/20">
              ...
              <button
                ...
                className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-700 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading ? (
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl border transition hover:bg-gray-50 dark:hover:bg-gray-800"
                >
                  <ShieldCheck size={18} />
            ...
            <div className="mt-8 space-y-3">
              ...
              <a
                ...
                className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl border border-blue-200 text-blue-700 transition hover:bg-blue-50 dark:border-blue-700 dark:text-blue-300 dark:hover:bg-blue-900/20"
              >
                <Headphones size={18} />
                Contact Admin
              </a>
              ...
              <a
                href="mailto:iphindore@gmail.com"

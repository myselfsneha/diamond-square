          ...
          >            {/* Login */}
            ...
            <div>
              ...
              <input
                ...
                className="mt-3 w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none"
              />

...
<div className="text-center">
  ...
  <motion.div
    ...
    className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 via-indigo-600 to-indigo-700 text-white shadow-2xl ring-8 ring-blue-100 dark:ring-slate-800"
  >
    <Building2 size={42} />
  </motion.div>
  ...
  <motion.p
    ...
    className="mt-2 text-base font-semibold text-blue-600"
  >
    {greeting}
  </motion.p>
...
<motion.div
  ...
  className="mt-6 rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 via-sky-50 to-indigo-50 p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800"
>
  ...
  <div className="flex gap-4">
    ...
    <div>
      ...
      <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
        Securely manage your society with one login.
        Access maintenance bills, visitor approvals,
        notices, complaints, polls, events,
        documents and announcements anytime.
      </p>
...
{!isOnline && (
  ...
  <motion.div
    ...
    animate={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.3 }}
    className="mt-5 rounded-2xl border border-red-300 bg-red-50 px-4 py-3 shadow-sm dark:border-red-800 dark:bg-red-900/20"
  >

    <div className="flex items-start gap-3">

      <div className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/40">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-red-600 dark:text-red-400">
          Please reconnect to the internet before signing in.
        </p>
...
>
  ...
  <motion.button
    ...
    className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 py-3 font-semibold text-white shadow-lg transition-all hover:shadow-2xl disabled:cursor-not-allowed disabled:opacity-60"
  >
  ...
  {failedAttempts >= 3 && (
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm dark:border-amber-700 dark:bg-amber-900/20"
    >
      ...
      <p className="mt-1 text-amber-600 dark:text-amber-400">
        Please verify your email/mobile number and password before trying again.
      </p>
...
<motion.div
  ...
  animate={{ opacity: 1 }}
  transition={{ delay: 0.3 }}
  className="mt-7 rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800"
>
  ...
  <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
    Create your Diamond Square account to access maintenance,
    visitor approvals, notices, complaints, polls, events,
    society documents and more.
  </p>

  <Link
    to="/register"
    className="mt-5 inline-flex w-full items-center justify-center rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white transition hover:bg-blue-700"
  >
    Create Account
  </Link>
...
<div className="mt-8 border-t border-gray-200 pt-5 text-center dark:border-slate-700">

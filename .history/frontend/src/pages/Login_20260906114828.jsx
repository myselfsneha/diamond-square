        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-5">
          <div className="w-full max-w-lg rounded-3xl bg-white dark:bg-gray-900 p-8 shadow-2xl">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-7">
              Diamond Square is a modern society management platform designed
              exclusively for our residential community. Residents can securely
              access notices, maintenance, complaints, documents, polls,
              notifications and other essential society services from one place.
            </p>

            <div className="mt-6 space-y-2 text-sm">
              <p><strong>Authentication:</strong> Email OTP Verification</p>
              <p><strong>Registration:</strong> Requires Admin Approval</p>
              <p><strong>Access:</strong> Resident & Admin Dashboards</p>

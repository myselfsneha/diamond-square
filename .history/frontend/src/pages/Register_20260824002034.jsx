...
function Register() {
  ...
  let passwordStrengthTextColor = "text-red-500";
  if (passwordStrength.label === "Strong") {
    passwordStrengthTextColor = "text-green-600";
  } else if (passwordStrength.label === "Medium") {
    passwordStrengthTextColor = "text-yellow-600";
  }
      ...
      >
        ...
        <div className="rounded-3xl border border-white/30 bg-white/85 dark:bg-gray-900/90 backdrop-blur-2xl shadow-2xl p-8">
          ...
          >
            ...
            <div>
              ...
              <div className="mt-2 flex items-center justify-between text-xs">
                ...
                <span className={`font-semibold ${passwordStrengthTextColor}`}>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300 mt-1 leading-relaxed">
                    After creating your account, an OTP will be sent for
                    verification. Once verified, your request will be reviewed
                    by the society administrator. You'll be able to log in after
          ...
          <div className="mt-8 text-center">
            ...
            <Link
              to="/"
              className="inline-flex items-center justify-center mt-3 font-semibold text-blue-600 hover:text-blue-700 transition-colors"
            >
              ← Back to Sign In
            </Link>
          </div>

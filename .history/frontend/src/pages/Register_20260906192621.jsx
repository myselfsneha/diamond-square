...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...form,
        family_members: form.family_members.map(({ id, ...member }) => member),
      };
              ...
              {form.family_members.map((member, index) => (
                ...
                >
                  <input
                    ...
                    value={member.name}
                    onChange={(e) =>
                      handleFamilyChange(member.id, "name", e.target.value)
                    }
                  ...
                  <input
                    ...
                    value={member.phone}
                    onChange={(e) =>
                      handleFamilyChange(member.id, "phone", e.target.value)
                    }
                    className="w-full rounded-xl border px-4 py-3 dark:bg-gray-800"
                  />

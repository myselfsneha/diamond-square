      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl text-white p-8 mb-8 shadow-lg">
          <div className="flex items-center gap-4">
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800/20 p-4 rounded-full">
              <User size={40} />
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {cards.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 rounded-2xl shadow p-6"
              >
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow p-6">
          ...
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow p-6">
            <div className="flex items-center gap-2 mb-5">
        ...
        <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow p-6">
